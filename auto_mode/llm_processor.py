...
20. ВАЖЛИВО! Коли є формат "Область: загрози біля Міста" - target це МІСТО, не область!
"Київщина: 4 шахеди на/повз Васильків" → target = "Васильків" (НЕ Київщина!)
"Чернігівщина: 2 шахеди кружляють біля Ріпок" → target = "Ріпки" (НЕ Чернігівщина!)
"Дніпропетровщина: 2 шахеди південніше Томаківки" → target = "Томаківка", target_offset = "південь"
{"threats": [
  {"action": "add", "threat_type": "drone", "count": 4, "target": "Васильків", "origin": "Росія", "origin_type": "direction"},
  {"action": "add", "threat_type": "drone", "count": 2, "target": "Ріпки", "origin": "Росія", "origin_type": "direction"},
  {"action": "add", "threat_type": "drone", "count": 2, "target": "Томаківка", "target_offset": "південь", "origin": "Росія", "origin_type": "direction"}
]}
...
- "ballistic" - балістична, балистика, іскандер, точка-у, ціль, цель
